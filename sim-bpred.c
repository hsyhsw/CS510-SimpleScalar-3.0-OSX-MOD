...
/* branch predictor type {nottaken|taken|perfect|bimod|2lev|piecewise} */
...
static int twolev_config[4] = { /* l1size */1, /* l2size */1024, /* hist */8, /* xor */FALSE };
...
void sim_reg_options(struct opt_odb_t *odb) {
	...
	opt_reg_int_list(odb, "-bpred:2lev", "2-level predictor config "
			"(<l1size> <l2size> <hist_size> <xor>)", twolev_config, twolev_nelt, &twolev_nelt,
	/* default */twolev_config,
	/* print */TRUE, /* format */NULL, /* !accrue */FALSE);

	// XXX: piecewise linear predictor, register manual config options
	opt_reg_int_list(odb, "-bpred:piecewise", "piecewise linear predictor config (<n> <m> <h>)", piecewise_config, piecewise_nelt, &piecewise_nelt,
	/* default */piecewise_config,
	/* print */TRUE, /* format */NULL, /* !accrue */FALSE);
...
void sim_reg_stats(struct stat_sdb_t *sdb) {
	...
	stat_reg_counter(sdb, "sim_num_branches", "total number of branches executed", &sim_num_branches, /* initial value */0, /* format */NULL);
